package com.CreditConveyor.Services;
...
public class CreditService {
    ...
    public CreditDTO createCredit(ScoringDataDTO scoringDataDTO){
        ...
        List<PaymentScheduleElementDTO> paymentScheduleElementsList = paymentScheduleList(amount,scoringDataDTO.getTerm(),rate,monthPayment);
    ...
    private BigDecimal psk(List<PaymentScheduleElementDTO> paymentScheduleElementList, BigDecimal amount){
    ...
    private List<PaymentScheduleElementDTO> paymentScheduleList (BigDecimal amount, Integer term, BigDecimal rate, BigDecimal monthPayment){
        ...
        PaymentScheduleElementDTO lastElement = paymentScheduleElementList.get(paymentScheduleElementList.size() - 1);
